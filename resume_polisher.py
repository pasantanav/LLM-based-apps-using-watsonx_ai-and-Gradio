...
gen_params = {
    "max_new_tokens": 512,
    "temperature": 0.7 # adjust for more creative variations
}
...
def polish_resume(position_name, resume_content, polish_prompt=""):
    ...
    if polish_prompt and polish_prompt.strip():
        ...
        prompt_use = f"Suggest improvements for the following resume content: '{resume_content}' to better align with the requeriments and expectations of a {position_name} position. Return the polished version, highlighting necessary adjustments for clarity, relevance and impact in relation to the targeted role."
